...
#inputfile
ibdf=args.ibdmatrix+"/trim"+str(trim)+"_"+"al1s_"+str(chr)+".csv.gz"
#outputfile
#frequency file
fibd=args.out+"/trim"+str(trim)+"_"+"af1s_"+str(chr)+".csv.gz"
...
pair['IDa']=pair['ID1'].astype(str)+"_ibd1s_"+pair['ID2'].astype(str)
pair['IDb']=pair['ID2'].astype(str)+"_ibd1s_"+pair['ID1'].astype(str)
