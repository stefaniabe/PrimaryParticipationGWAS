...
argParser.add_argument("--ibdmatrix", help="Path to the folder where the input IBD genotype matrix (output from previous step) is stored.")
...
#outputfile
#frequency file
fibd=args.out+"/trim"+str(trim)+"_"+"af0_"+str(chr)+".csv.gz"
